...
%py3_install
cp %{buildroot}/%{_bindir}/pylatest-quickstart %{buildroot}/%{_bindir}/pylatest-quickstart-3
ln -sf %{_bindir}/pylatest-quickstart-3 %{buildroot}/%{_bindir}/pylatest-quickstart-%{python3_version}
cp %{buildroot}/%{_bindir}/pylatest-rst2html %{buildroot}/%{_bindir}/pylatest-rst2html-3
ln -sf %{_bindir}/pylatest-rst2html-3 %{buildroot}/%{_bindir}/pylatest-rst2html-%{python3_version}
cp %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml-3
ln -sf %{_bindir}/pylatest-rst2pseudoxml-3 %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml-%{python3_version}
cp %{buildroot}/%{_bindir}/pylatest-preview %{buildroot}/%{_bindir}/pylatest-preview-3
ln -sf %{_bindir}/pylatest-preview-3 %{buildroot}/%{_bindir}/pylatest-preview-%{python3_version}
...
cp %{buildroot}/%{_bindir}/pylatest-rst2htmlplain %{buildroot}/%{_bindir}/pylatest-rst2htmlplain-3
ln -sf %{_bindir}/pylatest-rst2htmlplain-3 %{buildroot}/%{_bindir}/pylatest-rst2htmlplain-%{python3_version}

%py2_install
cp %{buildroot}/%{_bindir}/pylatest-quickstart %{buildroot}/%{_bindir}/pylatest-quickstart-2
ln -sf %{_bindir}/pylatest-quickstart-2 %{buildroot}/%{_bindir}/pylatest-quickstart-%{python2_version}
cp %{buildroot}/%{_bindir}/pylatest-rst2html %{buildroot}/%{_bindir}/pylatest-rst2html-2
ln -sf %{_bindir}/pylatest-rst2html-2 %{buildroot}/%{_bindir}/pylatest-rst2html-%{python2_version}
cp %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml-2
ln -sf %{_bindir}/pylatest-rst2pseudoxml-2 %{buildroot}/%{_bindir}/pylatest-rst2pseudoxml-%{python2_version}
cp %{buildroot}/%{_bindir}/pylatest-preview %{buildroot}/%{_bindir}/pylatest-preview-2
ln -sf %{_bindir}/pylatest-preview-2 %{buildroot}/%{_bindir}/pylatest-preview-%{python2_version}
...
cp %{buildroot}/%{_bindir}/pylatest-rst2htmlplain %{buildroot}/%{_bindir}/pylatest-rst2htmlplain-2
ln -sf %{_bindir}/pylatest-rst2htmlplain-2 %{buildroot}/%{_bindir}/pylatest-rst2htmlplain-%{python2_version}
...
%changelog
* Mon Aug 14 2017 Martin Bukatovic <mbukatov@redhat.com> - 0.1.1-1
- Initial package.
